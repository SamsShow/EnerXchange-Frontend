    ...
    <div className="bg-black text-white min-h-screen">
      ...
      >
        <div className="max-w-6xl mx-auto">
          <img
            className="mx-auto sm:px-4 md:px-[450px] py-5"
            src={logo}
            alt="logo"
          />
          ...
          >
            Revolutionizing peer-to-peer energy trading with blockchain
            technology
          </motion.p>
          ...
          <motion.div
            variants={staggerChildren}
            className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 transition-all"
          >
            <div className="overflow-hidden rounded">
              <img
                ...
                alt="Blockchain"
                className="w-full h-[280px] md:h-[480px] transition-transform duration-300 ease-in-out transform hover:scale-110"
              />
            </div>
            <div className="overflow-hidden rounded">
              <img
      ...
      >
        <div className="max-w-6xl mx-auto px-4">
          <motion.h2 variants={fadeIn} className="text-4xl font-bold mb-8">
            HOW EnerXchange WORKS
          </motion.h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <motion.div variants={fadeIn}>
              <img
                src="https://plus.unsplash.com/premium_photo-1682309671884-6b4cc375b376?q=80&w=1512&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                alt="P2P Energy Trading Process"
            ...
            <motion.div variants={staggerChildren}>
              ...
              <motion.ul variants={staggerChildren} className="list-disc pl-5">
                <motion.li variants={fadeIn}>
                  Connect your renewable energy source to our smart grid
                </motion.li>
                <motion.li variants={fadeIn}>
                  Set your energy price and trading preferences
                </motion.li>
                <motion.li variants={fadeIn}>
                  Our blockchain ensures secure and transparent transactions
                </motion.li>
                <motion.li variants={fadeIn}>
                  Buyers can purchase locally produced renewable energy
                </motion.li>
                <motion.li variants={fadeIn}>
                  Smart contracts automate payments and energy distribution
                </motion.li>
              </motion.ul>
            </motion.div>
          </div>
            ...
            {[
              ...
              >
                ...
                <p className="text-gray-400">
                  How {feature.toLowerCase()} enhances your energy trading
                  experience.
                </p>
              </motion.div>
            ))}
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          >
            {[
              ...
              >
                <img
                  src={`https://plus.unsplash.com/premium_photo-1674506654010-22677db35bdf?q=80&w=1460&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D`}
                  alt={benefit}
                ...
                <div className="p-4">
                  ...
                  <p className="text-sm text-gray-400">
                    How {benefit.toLowerCase()} impacts you and your community.
                  </p>
                </div>
              </motion.div>
            ))}
